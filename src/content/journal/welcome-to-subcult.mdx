...
export const frontmatter = {
  ...
  excerpt: "The underground doesn't die — it mutates. Welcome to the digital underworld.",
  coverImage: "/assets/journal/welcome.jpg",
  description: "Introducing Subcult: A collective for underground creators, artists, and rebels",
...
The revolution won't be televised. It'll be *coded*, *designed*, *composed*, and *streamed* by us.
