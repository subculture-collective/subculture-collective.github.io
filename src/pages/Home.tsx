...
import { pageSEO, organizationSchema, websiteSchema } from '../data/seo-config'
          ...
          >
            ...
            >
              ...
              <div className="cyber-card">
                ...
                <p className="font-sans text-gray-400">
                  Join forces with other creators. Cooperatives over
                  corporations.
                </p>
              </div>
              ...
              <div className="cyber-card">
                ...
                <p className="font-sans text-gray-400">
                  Challenge the status quo. Build alternative systems and
                  spaces.
                </p>
              </div>
            </motion.div>
