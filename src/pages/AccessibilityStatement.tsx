...
function AccessibilityStatement() {
  ...
  return (
    <>
      <SEOHead pageSEO={pageSEO.accessibility!} structuredData={breadcrumb} />
        ...
        >
          ...
          >
            ...
            <p className="font-sans text-xl text-gray-300">
              SUBCULT.TV is committed to ensuring digital accessibility for
          ...
          >
            ...
            <div className="cyber-card">
              <p className="font-sans text-gray-300 mb-4">
                ...
                to ensure our content is perceivable, operable, understandable,
            ...
            <div className="cyber-card space-y-4">
              <div>
                ...
                <p className="font-sans text-gray-400">
                  All interactive elements are accessible via keyboard. Use Tab
                  to navigate forward, Shift+Tab to navigate backward, and Enter
                  or Space to activate elements.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-sans text-gray-400">
                  A "Skip to main content" link appears when you first press
                  Tab, allowing you to bypass navigation and jump directly to
                  the main content.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-sans text-gray-400">
                  ...
                  website will minimize or remove animations to reduce the risk
          ...
          >
            ...
            <div className="cyber-card">
              ...
              <ul className="font-sans text-gray-300 list-disc list-inside space-y-2">
                ...
                <li>
                  Third-party embedded content may not meet the same
                  accessibility standards
                </li>
              </ul>
              <p className="font-sans text-gray-300 mt-4">
                We are actively working to address these issues in future
                updates.
              </p>
            </div>
          </motion.section>
          ...
          >
            ...
            <div className="cyber-card">
              <p className="font-sans text-gray-300 mb-4">
                Our website's accessibility relies on the following
                technologies:
              </p>
              <ul className="font-sans text-gray-300 list-disc list-inside space-y-2">
          ...
          >
            ...
            <div className="cyber-card">
              ...
              <p className="font-sans text-gray-300 mt-4">
                ...
                days and to implement necessary improvements as quickly as
                possible.
              </p>
            </div>
          </motion.section>
